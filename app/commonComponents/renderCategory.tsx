  ...
  return (
    <div className="relative group">
      ...
      <Link
        ...
        className="flex items-center space-x-1 px-3 py-2 text-gray-700 hover:text-lime-500 transition-colors duration-200"
      >
            ...
            {category.subcategories.map((sub) => (
              <li key={sub.id} className="relative group/sub">
                <Link
                  ...
                  className="flex items-center justify-between px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-lime-500 transition-colors rounded-md"
                >

        ...
        <div className="flex flex-col items-center">
          ...
          <ul className="space-y-3 text-sm text-green-200">
            <li>
              <Link
                href="/products"
                className=" hover:text-lime-300 hover:scale-"
              >
                All Products
              </Link>
            </li>
            <li>
              <Link href="/categories" className="hover:text-lime-300">
                Categories
              </Link>
            </li>
            <li>
              <Link href="/offers" className="hover:text-lime-300">
                Offers
              </Link>
            </li>
            <li>
              <Link href="/new-arrivals" className="hover:text-lime-300">
                New Arrivals
              </Link>
            </li>
          </ul>
